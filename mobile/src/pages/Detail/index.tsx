...
import { Feather as Icon, FontAwesome as IconAwesome } from '@expo/vector-icons'
...
const Detail = () => {
  ...
  function handleComposeMail() {
    MailComposer.composeAsync({
      subject: "Intesse na coleta de resíduos",
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.footer}>
        <RectButton style={styles.button} onPress={handleWhatsapp} >
          <IconAwesome name="whatsapp" size={20} color="#FFF" />
